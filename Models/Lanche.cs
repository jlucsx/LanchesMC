...
public class Lanche
{
    ...
    [MaxLength(200, ErrorMessage = "Descrição deve ter no máximo {1} caractesres.")]
    ...
    public int CategoriaId { get; set; } // para definir a propriedade de navegação
    public virtual Categoria Categoria { get; set; } // com a tabela Lanches
}